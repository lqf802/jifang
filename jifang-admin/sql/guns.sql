...
DROP DATABASE IF EXISTS jifang_flowable;
CREATE DATABASE IF NOT EXISTS jifang_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS jifang;
CREATE DATABASE IF NOT EXISTS jifang DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用', '2017-01-11 08:53:20', '1');
